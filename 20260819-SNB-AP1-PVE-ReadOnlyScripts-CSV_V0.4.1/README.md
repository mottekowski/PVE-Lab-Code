# AP1 PVE/Ceph Read-only Cluster Collector - V0.4.1

## Zweck

Dieses Paket dient zur technischen AP1-Datenerfassung auf einem Proxmox-VE-Cluster mit integriertem Ceph. V0.4.1 erweitert die normalisierten V0.3-Collector um eine zentrale Cluster-Ausführung per SSH.
...
`--run-id` folgt bewusst dem Format `YYYYMMDD_HHMM`.
