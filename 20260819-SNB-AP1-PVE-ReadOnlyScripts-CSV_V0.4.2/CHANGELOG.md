...
- Auditability: explizite IANA-Zeitzone für automatische Run-ID und ISO-8601-Zeitstempel; Default `Europe/Berlin`, optional `--timezone`/`AP1_TIMEZONE`.
- Keine Änderung an Orchestrierung, All-Host-/Cluster-Once-Zuordnung, Ablagestruktur oder Merge-Architektur.
